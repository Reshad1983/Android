...
public class VaxjoWeather extends ListActivity {
	...
	private String[] urls = new String[]{"http://www.yr.no/sted/Sverige/Kronoberg/V%E4xj%F6/forecast.xml",
    ...
    private class WeatherRetriever extends AsyncTask<URL, Void, WeatherReport>
	{
    	protected WeatherReport doInBackground(URL... urls) {
    		try {
				WeatherReport new_report = WeatherHandler.getWeatherReport(urls[0]);
    			return new_report;
    		} catch (Exception e) {
    ...
    private int getIdForIcon(WeatherForecast forecastBundle)
    {
