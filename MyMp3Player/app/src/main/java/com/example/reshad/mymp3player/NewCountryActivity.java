...
public class NewCountryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        country_list = intent.getStringArrayListExtra(VisitedCountry.COUNTRY_LIST);
        insert_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                try
                {
                    ...
                    Intent intent = new Intent(getApplicationContext(), VisitedCountry.class);
                    intent.putExtra("country_name", country_name);
                    intent.putExtra("date_of_visit", visit_date);
                    intent.putStringArrayListExtra(VisitedCountry.COUNTRY_LIST, country_list);
